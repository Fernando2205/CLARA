    ...
    <main className='mapa-screen'>
      ...
      <div className='mapa-layout'>
        ...
        <div className='legend-row'>
          <span><span className='dot' />Pendiente</span>
          <span><span className='dot state-ok' />Coincide con el sistema</span>
          <span><span className='dot state-warn' />Diferencia leve — revisar</span>
          <span><span className='dot state-bad' />Anomalía</span>
        </div>
      </div>
    </main>
  )
